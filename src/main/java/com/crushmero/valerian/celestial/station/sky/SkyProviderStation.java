...
/**
 * Copy of GalacticraftCore's SkyProviderOrbit with a few things changed
 *
 */
public class SkyProviderStation extends IRenderHandler {
	private final ResourceLocation sunTexture = CelestialObjects.VALERIAN.getMainStar().getBodyIcon();
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		final float[] var24 = this.minecraft.world.provider
				.calcSunriseSunsetColors(this.minecraft.world.getCelestialAngle(partialTicks), partialTicks);
		float var9;
		float var10;
		float var11;
		float var12;
		...
		if (var24 != null) {
			...
			GL11.glRotatef(
					MathHelper.sin(this.minecraft.world.getCelestialAngleRadians(partialTicks)) < 0.0F ? 180.0F : 0.0F,
					0.0F, 0.0F, 1.0F);
		...
		var12 = 28.0F;
		this.minecraft.renderEngine.bindTexture(this.sunTexture);
